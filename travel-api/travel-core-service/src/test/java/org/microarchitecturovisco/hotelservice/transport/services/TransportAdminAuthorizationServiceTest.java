...
class TransportAdminAuthorizationServiceTest {

    private MockRestServiceServer server;
    private TransportAdminAuthorizationService service;

    @BeforeEach
    void setUp() {
        RestTemplate restTemplate = new RestTemplate();
        server = MockRestServiceServer.bindTo(restTemplate).build();
        service = new TransportAdminAuthorizationService(restTemplate);
    }
