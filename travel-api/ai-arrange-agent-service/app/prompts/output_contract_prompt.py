...
- places: an array of place objects compatible with placeId, name, type, source, internalOfferId,
  ...
  bookingLinks. bookingLinks entries may include type, label, url, hotelId, ticketOfferId,
  routeFrom, routeTo, departureDate, bookingCode, provider, price.
  User-facing description must be Simplified Chinese. Do not invent image URLs or booking links.
...
When candidatePlaces include bookingLinks, preserve them in places and include the relevant links in markdown.
