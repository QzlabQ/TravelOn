...
public class CityCatalog {
    ...
    public CityCatalog(
            ...
            @Value("${app.seed-data.base-path:file:../seed-data/hotel/}") String seedDataBasePath,
    ...
    private String commonBasePath() {
        ...
        return base.endsWith("/hotel/") ? base.substring(0, base.length() - "hotel/".length()) + "common/" : base + "common/";
    }
