                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">
                          ...
                          {selectedOffer.arrivalTime} · {selectedOffer.duration}
                        </p>
                      </div>
      ...
      {selectedOffer && (
        <CheckoutConfirmDialog
          ...
          summaryRows={[
            ...
            {
              label: "时间",
              value: `${selectedOffer.departureTime} - ${selectedOffer.arrivalTime}`,
            },
