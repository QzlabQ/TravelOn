...
import {bookTicket, cancelReservation, isoDate, waitForDefaultTicketLocations} from './support/booking';
...
test('火车票可以按车次类型和车次号筛选', async ({page}) => {
    ...
    await waitForDefaultTicketLocations(page, '/reservations/trains');
