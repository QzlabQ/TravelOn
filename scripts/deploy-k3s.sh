...
for deployment in discovery gateway hotel transport user community order ai-arrange ai-arrange-agent; do
...
for deployment in rabbitmq discovery gateway hotel transport user community order ai-arrange ai-arrange-agent travelon-ui; do
